"""
cli/cmd_centrality.py — swiftkg centrality command.

Structural Importance Ranking (SIR) over the SwiftKG graph.
"""
...
def centrality(
    ...
    """Compute Structural Importance Ranking over the resolved SwiftKG graph."""
