"""
cli/cmd_query.py — swiftkg query / pack commands.
"""
...
def pack(
    ...
    """Pack source snippets from the Swift knowledge graph."""
    from swift_kg.kg import SwiftKG  # pylint: disable=import-outside-toplevel
